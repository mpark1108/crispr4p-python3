...
class TableSorting:
    """Stable sort over selected row positions."""
...
def guide_table(guide_matches):
    """Build and sort guide rows."""
    table = []
    ...
    # Keep the original IndexError for an empty result.
    return TableSorting(
        (2, len(table[0]) - 1),
        reversed_sort=True,
