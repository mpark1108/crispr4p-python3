"""Homology and primer3 computations independent of the legacy engine."""
...
def build_hr_dna(
    ...
    """Build the two legacy HR oligos and joined 250-bp flanks."""
...
def design_checking_primers(
    ...
    """Design the legacy verification-primer alternatives around a region."""
    ...
    for index in range(number_of_alternatives):
        ...
        checking_primers.append(alternative)
